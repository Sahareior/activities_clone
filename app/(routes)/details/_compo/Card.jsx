...
const ProductCard = ({ product, handleClick }) => {
  return (
    <div className="w-full md:max-w-[180px] shadow-md flex flex-row md:flex-col items-center mt-4 p-3 rounded-lg gap-3">
      {/* Product Image */}
      ...
      <div className="flex flex-col w-1/2 md:w-full justify-center">
        ...
        <p className="text-[13px] mmed mt-2 font-semibold text-gray-600">{`AED ${product.price.toFixed(2)}`}</p>
      </div>
    </div>
  );
};
